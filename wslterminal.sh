...
echo ""
echo -e "\033[1;34mCStar\033[0m \x1B[35mCSLE\x1B[0m"
echo -e "Detected OS: \033[1;34m$os_name\033[0m"
echo -e "\033[1;34mCStar\033[0m \x1B[35mLinux Environment\x1B[0m"
echo -e "Type: \033[1;33m'wsl\033[0m \033[1;30m--help\033[0m' for commands"
echo ""
sleep 1

# Looped input
while true; do
    read -p "$(echo -e "\033[1;32m$(whoami)@$(hostname)\033[0m:\033[0;34m/mnt$PWD\033[0m$ ")" input
    ...
    if [[ "$input" == "$compilerpkg" ]] && [[ "$os_name" == MINGW* || "$os_name" == CYGWIN* || "$os_name" == MSYS* ]]; then
        ...
        echo "Restarting CSLE with the latest update build..."
        sleep 2
        exec "$(realpath "$0")"
    ...
    elif [[ "$input" == "wsl --help" ]]; then
        echo "CStar CSLE Installer Help"
        echo ""
